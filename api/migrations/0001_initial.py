# Generated by Django 3.2.11 on 2022-02-16 17:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_that_want_to_join_ID', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Report',
        ...
        migrations.AddField(
            ...
            name='member1_ID',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='member1_ID', to='api.waitingroom', to_field='user_that_want_to_join_ID'),
        ),
        migrations.AddField(
            model_name='activesession',
            name='member2_ID',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='member2_ID', to='api.waitingroom', to_field='user_that_want_to_join_ID'),
        ),
        migrations.AddField(
            model_name='activesession',
            name='messages_IDs',
        ...
        migrations.AddField(
            model_name='circle',
            name='users_IDs',
            field=models.ManyToManyField(blank=True, related_name='users_IDs', to='api.Profile'),
        ),
    ]
