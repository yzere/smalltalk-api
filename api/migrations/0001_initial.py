# Generated by Django 3.2.11 on 2022-03-01 10:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stats', models.JSONField(blank=True, null=True)),
                ('social_link', models.JSONField(blank=True, null=True)),
                ('name', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_sessions_IDs', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.activesession')),
                ('user_that_want_to_join_ID', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Report',
        ...
        migrations.AddField(
            model_name='circle',
            name='reports_IDs',
            field=models.ManyToManyField(blank=True, to='api.Report'),
        ),
        migrations.AddField(
            model_name='circle',
            name='users_IDs',
            field=models.ManyToManyField(blank=True, related_name='users_IDs', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='activesession',
            name='circle',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.circle'),
        ),
        migrations.AddField(
            model_name='activesession',
            name='member1_ID',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='member1_ID', to='api.waitingroom', to_field='user_that_want_to_join_ID'),
        ),
        migrations.AddField(
            model_name='activesession',
            name='member2_ID',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='member2_ID', to='api.waitingroom', to_field='user_that_want_to_join_ID'),
        ),
        migrations.AddField(
            model_name='activesession',
            name='messages_IDs',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='admin_users_IDs', to='api.Profile'),
        ),
    ]
